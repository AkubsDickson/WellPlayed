...
if (isset($_POST['create'])) {
	...
	$user_data = 'TeamName='.$TeamName. 'TeamLogo='.$TeamLogo. 'TeamScore='.$TeamScore. 'TeamPossession='.$TeamPossession. 'redCards='.$redCards. '&Shots='.$Shots;

	

       $sql = "INSERT INTO users2(TeamName, TeamLogo,TeamScore,TeamPossession,redCards,Shots) 
               VALUES('$TeamName', '$TeamLogo', '$TeamScore','$TeamPossession','$redCards','$Shots')";
